...
$p=13$ dan $q=2$, yaitu sebesar `16.55044	`. Artinya, model autoregressive optimum 
didapat ketika $p=13$ dan $q=2$. Selanjutnya nilai ini akan dimasukkan ke 
...
memiliki nilai MAPE yang terkecil dibandingkan *Model Koyck* dan 
*Model ARDL*.
