...
akurasi1.train
```
Akurasi pada model `Winter1 optimal` dengan data training lebih baik dibandingkan model `Winter1`. Ditandai dengan nilai SSE, MSE, dan RMSE yang lebih kecil.
...
```
Akurasi pada model `Winter1` dengan data testing lebih baik dibandingkan model `Winter1 optimal`. Ditandai dengan nilai SSE, MSE, dan RMSE yang lebih kecil.